	...
	if (currentQuestion == totalQuestions) {
        ...
        <button class="restart">Restart Quiz</button>
         `;
	        ...
	        //Reference: https://blog.healthypawspetinsurance.com/8-best-cat-breeds-for-first-time-owners
			</div>
        <button class="restart">Restart Quiz</button>
         `;
		}
        ...
        <button class="restart">Restart Quiz</button>
         `;
	        ...
	        //Reference: https://www.thomasvillevet.net/site/blog/2020/08/17/best-pet-birds
			</div>
        <button class="restart">Restart Quiz</button>
         `;
		}
	        ...
	        // Reference: https://www.petsradar.com/features/five-popular-guinea-pig-breeds
			</div>
        <button class="restart">Restart Quiz</button>
         `;
		}
			...
			// Reference: https://firsthamster.com/these-are-the-4-best-hamsters-for-beginners/
        </div>
        <button class="restart">Restart Quiz</button>
         `;
		}
